    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="警告标题" prop="jinggaoName">
                       <el-input v-model="ruleForm.jinggaoName"
                                 placeholder="警告标题" clearable  :readonly="ro.jinggaoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="警告标题" prop="jinggaoName">
                           <el-input v-model="ruleForm.jinggaoName"
                                     placeholder="警告标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="警告内容" prop="jinggaoText">
                        <el-input type="textarea"  :readonly="ro.jinggaoText" v-model="ruleForm.jinggaoText" placeholder="警告内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jinggaoText" label="警告内容" prop="jinggaoText">
                            <span v-html="ruleForm.jinggaoText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jinggaoName: [
                              { required: true, message: '警告标题不能为空', trigger: 'blur' },
                          ],
                   jinggaoText: [
                              { required: true, message: '警告内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '警告时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jinggao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jinggaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
