    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="占的座位" prop="buyZuoweiNumber">
                       <el-input v-model="ruleForm.buyZuoweiNumber"
                                 placeholder="占的座位" clearable  :readonly="ro.buyZuoweiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="占的座位" prop="buyZuoweiNumber">
                           <el-input v-model="ruleForm.buyZuoweiNumber"
                                     placeholder="占的座位" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="占座日期" prop="buyZuoweiTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.buyZuoweiTime" label="占座日期" prop="buyZuoweiTime">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   buyZuoweiNumber: [
                              { required: true, message: '占的座位不能为空', trigger: 'blur' },
                          ],
                   buyZuoweiTime: [
                              { required: true, message: '占座日期不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '占座时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
