        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否禁用" prop="sexTypes">
                        <el-select v-model="ruleForm.xueshengJinyongTypes" :disabled="ro.xueshengJinyongTypes" placeholder="请选择是否禁用">
                            <el-option
                                    v-for="(item,index) in xueshengJinyongTypesOptions"
                                    v-bind:key="item.codeIndex"
                                    :label="item.indexName"
                                    :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否禁用" prop="xueshengJinyongValue">
                            <el-input v-model="ruleForm.xueshengJinyongValue"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    xueshengIdNumber: '',
                    xueshengPhoto: '',
                    xueshengJinyongTypes: '',
                    sexTypes: '',
                    xueshengEmail: '',
                },
                xueshengJinyongTypesOptions : [],
                sexTypesOptions : [],
                rules: {
                   username: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xuesheng_jinyong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengJinyongTypesOptions = data.data.list;
                    }
                });
