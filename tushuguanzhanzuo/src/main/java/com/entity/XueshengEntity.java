...
public class XueshengEntity<T> implements Serializable {
     ...
     * 性别
     */
    @TableField(value = "xuesheng_jinyong_types")

    private Integer xueshengJinyongTypes;
    ...
    public Integer getXueshengJinyongTypes() {
        return xueshengJinyongTypes;
    }

    public void setXueshengJinyongTypes(Integer xueshengJinyongTypes) {
        this.xueshengJinyongTypes = xueshengJinyongTypes;
    }
    ...
    public String toString() {
        return "Xuesheng{" +
            ...
            ", sexTypes=" + sexTypes +
            ", xueshengJinyongTypes=" + xueshengJinyongTypes +
