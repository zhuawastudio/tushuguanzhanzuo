...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (myThreadMethod == null) {
            ...
            FangjianOrderService fangjianOrderService = (FangjianOrderService)appContext.getBean("fangjianOrderService");
            myThreadMethod.setFangjianOrderService(fangjianOrderService);
